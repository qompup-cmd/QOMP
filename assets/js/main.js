...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "hero.h1": "Exploring microscopic physics from gas- to solid-state phases: attosecond physics extended to condensed matter physics",
      ...
      "director.titulo": "Welcome to the website of the Quantum Optics and Condensed Matter Physics group, led by Dr. Alexis Chacón",
      ...
      "int.intro_edit": "[EDIT with your actual members]",
      "int.eyebrow_lead": "Group leadership",
      "int.h2_lead": "Principal investigators",
      "int.role_pi": "Principal investigator",
      "int.role_coinv": "Co-investigator",
      "int.area_super_mat": "Superconductivity · Quantum materials",
      "int.area_semi": "Semiconductors · Optoelectronics",
      "int.area_sim_comp": "Simulation · Computational physics",
      "int.link_perfil": "Profile",
      "int.link_email": "Email",
      "int.eyebrow_training": "Early-career research",
      "int.h2_training": "Postdocs and students",
      "int.role_posdoc": "Postdoc",
      "int.area_nano2d": "2D nanomaterials",
      "int.role_doctorado": "PhD student",
      "int.area_magnetismo": "Magnetism",
      "int.role_maestria": "Master's student",
      "int.area_fotonica": "Photonics",
      "int.role_licenciatura": "Undergraduate",
      "int.area_caracterizacion": "Characterization",
      "int.area_superconductividad": "Superconductivity",
      "int.area_dft": "DFT simulation",
      "int.role_tecnico": "Technician",
      "int.area_laboratorio": "Laboratory",
      "int.area_optoelectronica": "Optoelectronics",
      "int.note_photos_1": "[EDIT: replace the initials with real photographs by placing images in ",
      "int.note_photos_2": " and replacing the ",
      "int.note_photos_3": " block with <img>.]",
      // --- Publicaciones ---
      ...
      "not.n1_title": "Award for best doctoral thesis",
      "not.n1_edit": "[EDIT]",
      "not.n1_sum": "A group member received recognition for their research on quantum materials.",
      "not.n1_link": "Read more →",
